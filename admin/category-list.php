...
<section class="page-section" style="overflow:auto;">
	<div class="row col-lg-12 col-center m-t-10">
		<table id="categories" class="cell-border" cellspacing="0" width="100%">
			<thead>
				<tr>
					<th>ID</th>
					<th>Назва</th>
					<th style="width: 280px;">Опис</th>
					<th>Статус</th>
					<th>Створено</th>
					<th>Редагувати</th>
				</tr>
    ...
    var table = $('#categories').DataTable({
        ...
        "rowCallback": function(row, data) {
            ...
            $(row).on('drop', function(event) {
                $.post('files/SSP/category_order.php', {
